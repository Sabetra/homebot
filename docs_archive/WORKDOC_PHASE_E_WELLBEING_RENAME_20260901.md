...
| 8 | Produktive klinischen Artefakte: `psychological_support.db` (66 MB), `.key` (44 B), `psychological_support_kg_cache/` | `~\.local\share\homebot_dbs\` Listing |
...
| 14 | Rollback-Position: Git-Tag `pre-phase-e` @ `b7177884` + DB-Backup `2026-09-01` (quick_check ok, Key dabei) | `git tag -l`, `~/homebot_backups/db/auto/2026-09-01/manifest.json` |

...
| Scanner-Integration (best-effort in `scan()`, `--no-enrich`) | Reachability-Analyse (Next-Step) |
| Test-Suite: 100 Tests / 17 Klassen grün | npm/NuGet/Cargo-Scans |
| Doku-Pflicht (Doc 16, funktionen.md §N, Worklog) | UI-Anzeige der Tiers (Streamlit) |
...
| 7 | `docs/16_DEPENDENCY_SCANNER.md` | SOTA-Risiko-Priorisierung §, Architektur, Security, Privacy, Usage, Offline/Refresh, Tests (100), Limitationen | — |
| 8 | `funktionen.md` | §N (Scanner) vollständig aktualisiert: Enrichment, 100 Tests, Kern-Komponenten, SOTA | — |

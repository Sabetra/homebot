...
|---|-------|----------|---------------|
| 1 | `docs_archive/WORKDOC_PUBLIC_LAUNCH_20260831.md` | angelegt | — |
...
| 4 | `docs_archive/WORKDOC_PUBLIC_LAUNCH_20260831.md` | abgeschnittenes Dateiende (Endigung mitten in "Änderungen") wiederhergestellt; DoD-Status, Offene Fragen/Risiken, Testergebnisse, Change-Log aktualisiert | Read-back-Verifikation |
...
| 4 | Backup-Ordner (falls nötig) | `~\homebot_backups\` |
...
| 3 | Git-Identität war Platzhalter (`IHR_GITHUB_USERNAME`) — betrifft nur die private Lokalhistorie (wird nicht gepusht) | mittel | Behoben 2026-08-31: repo-lokal `user.name`/`user.email` = „Michaël Artebas <E-Mail redigiert>"; trägt nur der neue Initial-Commit |

...
FINANCE_ANALYTICS: List[str] = [
    ...
    "finance_list_goals",
    "finance_list_forecast_suppressions",
    "finance_list_rules",
    "finance_list_series",
    "finance_list_series_candidates",

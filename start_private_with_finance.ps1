# PRIVATE BOT STARTUP (Finance Tab enabled)
# Usage: .\start_private_with_finance.ps1
#
...
Write-Host "STARTE PRIVATE BOT (MIT FINANCE TAB)" -ForegroundColor Cyan
Write-Host "=" * 80 -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  APP_ENABLE_FINANCE_TAB: $env:APP_ENABLE_FINANCE_TAB (PRIVATE)" -ForegroundColor White
Write-Host ""
